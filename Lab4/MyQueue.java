...
public class MyQueue<Item> implements Iterable<Item> {
     ...
     * Node object. Attributes: next: reference to the next node data: the generic
    ...
    /**
     * printQueue prints out every value of the nodes in the queue in LIFO order in
     * the form like followed [Item1, Item2 , ... , ItemN].
     */
