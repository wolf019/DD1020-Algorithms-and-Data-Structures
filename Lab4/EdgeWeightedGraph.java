 ...
 * incident to a vertex. It also provides methods for returning the degree of a
 * vertex, the number of vertices <em>V</em> in the graph, and the number of
 * edges <em>E</em> in the graph. Parallel edges and self-loops are permitted.
